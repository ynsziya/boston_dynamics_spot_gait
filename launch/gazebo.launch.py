...
def generate_launch_description():
    ...
    # Gazebo resolves "package://robot_dog_gait/meshes/..." URIs by
    # searching GZ_SIM_RESOURCE_PATH for a directory literally named
    # "robot_dog_gait" containing a "meshes" subfolder -- that's exactly
    # share/robot_dog_gait, so we add its parent to the search path.
